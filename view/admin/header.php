    ...
    <header class="header-section">
        <div class="container">
            <div class="header-wrapper">
                ...
                <ul class="menu">
                    <li>
                        <a href="http://localhost/clones/booking-site-03/admin_home" class="active">Admin Home</a>
                    </li>
                    <li>
                        <a href="http://localhost/clones/booking-site-03/home">site</a>
                    </li>
                  
                    <?php 
                        if(isset($this->user_info["admin_name"])){
                            $name = $this->user_info["admin_name"];
