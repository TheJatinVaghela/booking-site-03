                ...
                <div class="account-area">
                    ...
                    <form action="" method="post" class="account-form">
                        <div class="form-group">
                            ...
                            <input type="text" placeholder="Enter Your Email" name="user_email" id="email2" required>
                        </div>
                        <div class="form-group">
                            <label for="pass3">Password<span>*</span></label>
                            <input type="password" placeholder="Password" name="user_password" id="pass3" required>
                        </div>
